  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Mess Bill</li>
      </ol>
    ...
    <?php endif ?>
      ...
      <div class="row">
        ...
        $q="SELECT bill_stdid,bill_type,bill_amt,bill_duedate,bill_id FROM bill WHERE bill_stdid='$tid' AND bill_type='Mess Bill'AND bill_sts='Not Paid'";
